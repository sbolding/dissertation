...
%Adjust margin to be more in
\setlength{\leftmargini}{0.14\textwidth}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \addtolength{\leftmargini}{0.08in}
\begin{frame}
...
\begin{itemize}
    \item[] Materials under extreme conditions \\ {\color{Gray} Temperatures on order of $10^6$ K or more}
    \item[] Photon radiation field interacts with material \\ 
        {\color{Gray} Significant \colb{energy} and momentum may be exchanged}
 \item[] We want to improve efficiency of calculations \\
     {\color{Gray} for inertial confinement fusion, supernovae, et. al.}
    \end{itemize}
...
\begin{itemize}
    ...
    \item[] Photon radiation field interacts with material \\ 
        {\color{Gray} Significant \colb{energy} and momentum may be exchanged}
 \item[] We want to improve efficiency of calculations
     {\color{Gray} Inertial confinement fusion, supernovae, et. al.}
    \end{itemize}
%    \begin{picture}(130mm,85mm)
%\end{picture}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{We have applied our method to the 1D grey TRT equations}
...
\begin{frame}
    \frametitle{Our method improves on several aspects of IMC}
    \begin{columns}
