...
\begin{frame}
    \frametitle{We eliminate auxillary spatial unknowns  \\ to produce global
        system of equations
    }
    \begin{columns}
...
\begin{frame}
    \frametitle{Implementation specifics for most results are given below:}               
    ...
    \item Figure of Merit:  \boxed{\text{FOM}=\frac{\displaystyle 1}{\displaystyle
        \left(\frac{\ds\|\sigma(\phi_i)\|}{\ds\|\phi_i\|}\right)^2 N_{\text{total}}}}\\ \colG{normalized so IMC FOM=1}
    \end{itemize}
    }
\end{frame}
