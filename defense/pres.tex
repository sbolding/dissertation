...
\begin{frame}
    \frametitle{The time variable can be included in the ECMC trial space \\ allowing for
        accurate time integration of intensity }
    \begin{columns}
    ...
    \begin{itemize}
        ...
        \item[] Include continuous $\frac{1}{c}\pderiv{}{t}\left(\cdot\right)$ in $\B L$ for residual
            ...
            \begin{equation*}
                ...
                \frac{1}{c}\pderiv{\tilde I}{t} - \mu \pderiv{\tilde I}{x} - \sigma_t
                \pderiv{\tilde I}{x} 
