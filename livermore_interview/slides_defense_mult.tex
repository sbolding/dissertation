...
\begin{frame}
\frametitle{Multiplicity experiments were performed at Sandia \\ for validating subcritical
simulations}
...
\begin{itemize}
  ...
  \item[] Solomon modeled experiments with MCNP
\end{itemize} 
}
\end{minipage}
