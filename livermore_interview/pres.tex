...
\begin{frame}
    ...
    \begin{itemize}
    \item Written as stand-alone C++ code
...
\section{Extensions and Improvements on Algorithm}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item[] Sample and track in time \\ \colG{Tally time-average error projection and at $t^{n+1}$}
        \vspace{0.08in}
...
\begin{frame}
    \frametitle{The time-closure parameters preserve MC time integration \\ in the LO solution}
...
\begin{frame}
    \frametitle{A couple other improvements I didn't have time to discuss}
    {\addtolength\wideitemsep{5pt}
        \begin{itemize}
        \item[] The HO solution can be used to estimate the spatial closure \\
                \colG{by including face tallies in ECMC}
            \item[] Source iteration with diffusion synthetic acceleration \\ \colG{as a
                    solution to the LO equations}
        \end{itemize}}
\end{frame}
...
S.R. Bolding, M. Cleveland, and J.E. Morel. A High-Order Low-Order Algorithm with
Exponentially-Convergent Monte Carlo for Thermal Radiative Transfer. Nuclear Science \&
Engineering: M\&C 2015 Special Issue, 2016. Accepted.
    \end{itemize}
\end{frame}
