...
Backward Euler (BE) time-discretized S 2 equations.
 The
main interest is in increasing accuracy in resolution of radiation wavefronts in optically
thin regions, where particles transport a long distance over a time step. In such regions, the MC
integration of the time variable by IMC in the transport equation can produce greater
