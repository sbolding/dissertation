...
energy through absorption and emission of photons as the radiation traverses the material.  In this work, we neglect
motion of the material, which would require solution methods appropriate for
radiation hydrodynamics~\cite{radhydro}, although our solution method would be applicable for resolving the radiation
and internal energy distribution in a operator-split solution to such systems~\cite{radhydro}.
