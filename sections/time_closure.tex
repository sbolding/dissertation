...
\invcm; all other problem parameters are the same.



\section{Mixed Optical Thickness Problem}

It is important to demonstrate that the time-continuous case is still efficient in a mix
of optically thick and optically thin regions.  Simulations are performed for a three
region problem detailed in Fig.~\ref{???}.
