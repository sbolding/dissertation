...
\begin{figure}[htb]
  \centering
    ...
    \caption{\label{fig:void_imc_compare} Comparison of radiation temperatures for IMC and
    HOLO method, for time-averaged and census unknowns.}
\end{figure}
...
A comparison of the cell-averaged mean instensities for IMC and the HOLO method are given
in Fig.~\ref{blah}, showing a case for HOLO with a time closure and for the time-discrete
case.  A comparsion for radiation temperatures with 1 and 3 batches is given in Fig.~\ref{blah}, which
