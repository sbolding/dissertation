...
distribution must be modified to prevent biasing of the solution.
...
thin problem. Time step size is $\Delta t =0.002$ sh}
\end{figure}
...
problems.  Simulations are performed for the two material problem defined in
Sec.~\ref{sec:two_mat}.  We use   
